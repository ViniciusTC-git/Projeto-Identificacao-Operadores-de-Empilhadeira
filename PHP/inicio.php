 ...
 <div class="container-fluid">
  <div class="row">
                ...
                <button type='button' class='btn btn-success addbtn  my-2 mr-sm-2 text-white'><i  class='fas fa-user-plus' style="font-size: 1.45em;"></i></button>
                    <input class="form-control mr-sm-2"  type='text' name ='busca-cadastro' autocomplete="off"  placeholder="Buscar...">
                ...
                <?php
                    ...
                    $sql = "SELECT ID,Nome,Data FROM registro ORDER BY ID";
    ...
    $(document).ready(function(){
        $("#busca").keyup(function(){
            ...
            $.ajax(
            {
                url:'buscar.php',
                type:'POST',
                data:'busca-inicio='+keyword,
                success:function(response)
                {
                    $("#table-container").html("<h5 class='text-center'>Procurando....</h5>");    
                    setTimeout(function(){  
